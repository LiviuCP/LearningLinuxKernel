...
void GCD::Loader::loadKernelModule(const std::optional<std::filesystem::path>& modulePath)
{
...
std::optional<std::filesystem::path> GCD::Loader::getModulePath(const std::string_view moduleName)
{
